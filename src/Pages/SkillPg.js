            ...
            <div id='SkillPg-skillBox-container'>
                <div id='SkillPg-skillBox'>
                    ...
                    <div id="SkillPg-skillBox-content">
                        <SkillComp
                            desc="Exploring Server side rendering, Static Site generation with Next js enables me to create more optimal Web Applications."
                            heading="NextJS" />
                        <SkillComp
                        ...
                        <SkillComp
                            ...
                            heading="Redux" />
                        <SkillComp
                            desc="Postman one of the best Tool to manage your frontend and backend Integrations with all Api at one place."
                            heading="Postman" />
                        <SkillComp
